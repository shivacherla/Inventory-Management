...
public interface InventoryDAO {
    @SqlUpdate("CREATE TABLE IF NOT EXISTS inventory(id int auto_increment primary key, name varchar(50), category varchar(100), specifications varchar(2000), quantity int NOT NULL)")
    void createTable();
